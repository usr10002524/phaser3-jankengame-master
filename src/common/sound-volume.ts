...
export class SoundVolume {
    ...
    constructor(scene: Phaser.Scene, config: SoundVolumeConfig) {
        ...
        // アイコンの初期化
        {
            ...
            this.icon.setDepth(config.icon.depth);
            // 入力を受け付ける
        ...
        // ツマミ部分の初期化
        {
            ...
            this.handle.setDepth(config.handle.depth);
        ...
        // ゲージ部分の初期化
        {
            ...
            this.guage.setDepth(config.guage.depth.bar);
        ...
        // ゲージ背景の初期化
        {
            ...
            this.guageBg.setDepth(config.guage.depth.bg);
        ...
        // UIの背景
        {
            ...
            this.panel.setDepth(config.panel.depth);
